...
describe('token', () => {
    describe('.fetchToken', () => {
        test('returns the token succesfully', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect((0, token_1.fetchToken)('base-url', testToken.projectId, testToken.appId, testToken.deviceId, f, beforeExpiry(testToken))).resolves.toBe(testTokenString);
        }));
        test('throws if API call fails', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect((0, token_1.fetchToken)('base-url', testToken.projectId, testToken.appId, testToken.deviceId, f, beforeExpiry(testToken))).rejects.toThrow(err);
        }));
        test('throws if API returns non-OK status', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield expect((0, token_1.fetchToken)('base-url', testToken.projectId, testToken.appId, testToken.deviceId, f, beforeExpiry(testToken))).rejects.toThrow();
        }));
    ...
    describe('.validateToken', () => {
        test('returns true for correct token', () => {
            expect((0, token_1.validateToken)(testTokenString, testToken.projectId, testToken.appId, testToken.deviceId, beforeExpiry(testToken))).toBeTruthy();
        });
        test('returns false when projectId and appId does not match', () => {
            expect((0, token_1.validateToken)(testTokenString, 'other-app-id', testToken.projectId, testToken.deviceId, beforeExpiry(testToken))).toBeFalsy();
        });
        test('returns false when deviceId does not match', () => {
            expect((0, token_1.validateToken)(testTokenString, testToken.projectId, testToken.appId, 'other-device-id', beforeExpiry(testToken))).toBeFalsy();
        });
        test('returns false when token is expired', () => {
            expect((0, token_1.validateToken)(testTokenString, testToken.projectId, testToken.appId, testToken.deviceId, afterExpiry(testToken))).toBeFalsy();
        });
    });
    describe('.decodeToken', () => {
        test('decodes test token correctly', () => {
            expect((0, token_1.decodeToken)(testTokenString)).toMatchObject(testToken);
        });
        test('throws when token is invalid', () => {
            expect(() => {
                (0, token_1.decodeToken)('123456');
            }).toThrow();
        });
        test('throws when token is not base64 encoded', () => {
            expect(() => {
                (0, token_1.decodeToken)('123456.$$$$$$$@@@@@@@.123456');
            }).toThrow();
        });
        test('throws when token is not serialised JSON', () => {
            expect(() => {
                (0, token_1.decodeToken)('123456.123456.123456');
            }).toThrow();
        });
    });
});
